...
export interface IPostRepository {
  ...
  findAll(options?: PostQueryOptions): Promise<{ posts: IPostPublic[]; total: number }>;
  findPublished(options?: Omit<PostQueryOptions, 'status'>): Promise<{ posts: IPostPublic[]; total: number }>;
